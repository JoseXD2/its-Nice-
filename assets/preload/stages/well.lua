function onCreate()
	...
	makeLuaSprite('ground', 'lawn/groundwell', -1940, 750);
	...
	makeLuaSprite('fenc3', 'lawn/fence', -1500, 630);
	setScrollFactor('fenc3', 0.9, 0.9);
	scaleObject('fenc3', 1.2, 1.2);

	addLuaSprite('sky', false);
	addLuaSprite('cloud', false);
	addLuaSprite('fenc', false);
	addLuaSprite('fenc2', false);
	addLuaSprite('fenc3', false);
